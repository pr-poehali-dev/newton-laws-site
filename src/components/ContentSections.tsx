...
const ContentSections = ({ visibleSections, scrollProgress, scrollToSection }: ContentSectionsProps) => {
  const laws = [
    {
      number: 1,
      ...
      <section id="examples" className="py-20 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <p className={`text-center text-muted-foreground mb-16 text-lg transition-all duration-700 delay-100 ${
            ...
            Законы Ньютона работают везде вокруг нас
          </p>
            ...
            {examples.map((example, index) => (
              ...
              >
                <CardContent className="p-6">
                  ...
                  <div className="text-xs font-semibold text-primary mb-3">{example.law}</div>
